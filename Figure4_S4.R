...
hs_TEs <- mcreadRDS("./RNAseq_ref/TEtranscripts/hg38_rmsk_TE.rds",mc.cores=20)
hs_TEs$id <- paste0(hs_TEs[,1],"_",hs_TEs[,2],"_",hs_TEs[,3])
hs_TEs <- hs_TEs[!duplicated(hs_TEs$id),]
hs_TEs <- toGRanges(hs_TEs)

NF391.rmigg <- read.csv(row.names=1,"./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/NF391.peaks.rmIgG.csv")
NF391.rmigg.ol <- read.csv(row.names=1,"./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/NF391.peaks.rmIgG.ol.csv")
nrow(NF391.rmigg)
nrow(NF391.rmigg.ol)
...
NF391_vs_IgG_up <- read.table(file = "./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/NF391_vs_IgG_up.bed",
    sep="\t",header=FALSE)
...
4573/10589
write.csv(as.data.frame(NF391_vs_IgG_up.TE),"./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/NF391.vs.IgG.up.TE.anno.csv")

NF391_vs_IgG_up.TE <- read.csv(row.names=1,"./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/NF391.vs.IgG.up.TE.anno.csv")
...
write.table(NF391_vs_IgG_up.TE, file = "./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/NF391.vs.IgG.up.TE.anno.bed",
...
pdf("./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/TE.class.NF391.peaks.final.pdf")
pie1(table(NF391_vs_IgG_up.TE$TE.gene.class))
dev.off()


cd ./CUT-TAG/IPM/IPM_A549/bw_files/

computeMatrix reference-point --referencePoint center -b 3000 -a 3000 \
-R ./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/NF391.vs.IgG.up.TE.anno.bed \
-S IgG.bw combine_all_p391.bw \
--numberOfProcessors 30 --skipZeros \
--missingDataAsZero \
-o ./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/center.NF391.vs.IgG.up.TE.mat.gz 

plotHeatmap -m ./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/center.NF391.vs.IgG.up.TE.mat.gz \
 -out ./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/center.NF391.vs.IgG.up.TE.pdf  \
...
pdf("./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/all.class.NF391.peaks.final.pdf")
pie1(table(NF391.peak.all$ID))
dev.off()
...
write.csv(NF391_vs_IgG_up,"./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/NF391_vs_IgG_up_anno_final.csv")

NF391_vs_IgG_up <- read.csv(row.names=1,"./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/NF391_vs_IgG_up_anno_final.csv")
...
pdf("./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/all.class.NF391.peaks.final.final.pdf")
pie1(table(NF391_vs_IgG_up$anno11))
dev.off()
...
ATAC_DEG <- read.table(file = "./ATAC_Seq/IPM/IPM_A549/outs/DEG.peaks.4samples.bed")
...
write.csv(as.data.frame(ATAC.TE),"./ATAC_Seq/IPM/IPM_A549/outs/DEG.peaks.4samples.TE.anno.csv")

ATAC.TE <- read.csv(row.names=1,"./ATAC_Seq/IPM/IPM_A549/outs/DEG.peaks.4samples.TE.anno.csv")
...
write.csv(ATAC_DEG,"./ATAC_Seq/IPM/IPM_A549/outs/DEG.peaks.4samples.TE.anno.final.csv")

ATAC_DEG <- read.csv(row.names=1,"./ATAC_Seq/IPM/IPM_A549/outs/DEG.peaks.4samples.TE.anno.final.csv")
pie1(table(ATAC_DEG$anno))
pie1(table(ATAC_DEG$anno11))
tmp <- as.data.frame(table(ATAC_DEG$anno11))
tmp$pct <- tmp$Freq / sum(tmp$Freq)

pdf("./ATAC_Seq/IPM/IPM_A549/outs/all.class.ATAC.peaks.final.final.pdf")
pie1(table(ATAC_DEG$anno11))
dev.off()
...
H3K9_DEG <- fread(file = "./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_broad/DEG/H3K9me3.DEG.peaks.p0.05.FC1.bed")
...
write.csv(as.data.frame(H3K9.TE),"./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/H3K9.DEG.peaks.p0.05.FC1.TE.anno.csv")

H3K9.TE <- read.csv(row.names=1,"./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/H3K9.DEG.peaks.p0.05.FC1.TE.anno.csv")
...
write.csv(H3K9_DEG,"./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/H3K9.DEG.peaks.p0.05.FC1.TE.anno.final.csv")

H3K9_DEG <- read.csv(row.names=1,"./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/H3K9.DEG.peaks.p0.05.FC1.TE.anno.final.csv")
...
pdf("./CUT-TAG/IPM/IPM_A549/MACS3_new/hs_q0.05_narrow/DEG/all.class.H3K9me3.peaks.final.final.pdf")
pie1(table(H3K9_DEG$anno11))
dev.off()
